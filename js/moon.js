...
function init_scene() {
  ...
  camera = new THREE.PerspectiveCamera(
    ...
    0.1,
    1000
  ); //camera with param FOV, dim-canvas, min distance render, max distance render
...
function init_geometrics() {
  ...
  scene.add(cy);
  //capsule
  var dome_capsule = new THREE.SphereGeometry(
    8,
    64,
    64,
    0,
  ...
  var glassy_material = new THREE.MeshPhongMaterial({
    color: 0xa8ccd7,
    opacity: 0.3,
    transparent: true,
  });
